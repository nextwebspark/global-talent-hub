    ...
    companies: {
      ...
      items: {
        ...
        properties: {
          ...
          revenue: { type: "string", description: "Annual revenue with currency and year, e.g., 'SAR 75.3bn 2023', 'AED 28.4 billion FY2024', '$15.2B 2023'. Include the exact figure from authoritative sources." },
